-- Persist the normalized single-unit reservation context atomically.
-- Multi-unit allocation remains an MM3 concern and is rejected by the Edge Function.
...
begin
    ...
    if p_unit_rental_price is null
       ...
       or p_deposit_amount <> v_deposit_amount
